...
{
	public void Add<TRet>(string propertyName, string description, PropertyReadDelegate<TRet, TInstance>? readTyped = null, PropertyWriteDelegate<TInstance, TRet>? writeTyped = null, PropertyType propertyType = PropertyType.Default) =>
